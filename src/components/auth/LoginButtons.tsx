...
export function LoginButtons() {
  ...
  return (
    <div className="bg-card"> {/* Ensures base background is card color */}
      <Card className="w-full min-h-screen shadow-none rounded-none flex flex-col">
        ...
        <CardContent className="p-8 md:p-10 flex-grow overflow-y-auto">
          <div className="w-full max-w-2xl mx-auto space-y-12"> {/* Centered content with max-width and spacing */}
            <div>
