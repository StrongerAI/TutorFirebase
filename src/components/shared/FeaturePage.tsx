...
export function FeaturePage({ title, description, icon: Icon, children, className, actionButtons }: FeaturePageProps) {
  return (
    <div className={`h-full overflow-y-auto p-4 sm:p-6 space-y-6 ${className}`}>
...
export function GenAiFeaturePage({ title, description, icon: Icon, formComponent, resultComponent, isLoading, className }: GenAiFeaturePageProps) {
  return (
    <div className={`h-full overflow-y-auto p-2 sm:p-6 space-y-6 ${className}`}>
        ...
        <CardHeader className="bg-muted/30 border-b p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-sm md:text-md">{description}</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-4 sm:p-6">
